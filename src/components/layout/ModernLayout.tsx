...
import { Calendar, BarChart3, Package, FileText, Settings, Home, Users, Factory, ShoppingCart, Sparkles, ArrowLeft, ClipboardList } from 'lucide-react';
...
export const ModernLayout: React.FC<ModernLayoutProps> = ({
  ...
  const sidebarItems = [
    ...
    { id: 'inventory', label: 'Inventory', icon: ShoppingCart, path: '/inventory', available: false, isSpecial: false },
